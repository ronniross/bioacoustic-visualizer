...
Generates animated 3D pitch trajectories from bioacoustic signals. This script calculates STFT, extracts peak frequency/amplitude data over time, and renders a smooth, rotating 3D animation with live frequency tracking.
